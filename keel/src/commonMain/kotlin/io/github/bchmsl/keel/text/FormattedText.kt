 ...
 */
public sealed interface FormattedNode {

    /** Text with no markers in it. */
    public data class Plain(val text: String) : FormattedNode
     ...
     */
    public data class Link(val url: String) : FormattedNode

    public data class Bold(val children: List<FormattedNode>) : FormattedNode

    public data class Italic(val children: List<FormattedNode>) : FormattedNode

    public data class Underline(val children: List<FormattedNode>) : FormattedNode
     ...
     * markers themselves.
     */
    public data class Code(val text: String) : FormattedNode
}
 ...
 */
public fun parseFormattedText(text: String): List<FormattedNode> {
...
private fun String.isLoneAsteriskAt(index: Int): Boolean = this[index] == ASTERISK &&
