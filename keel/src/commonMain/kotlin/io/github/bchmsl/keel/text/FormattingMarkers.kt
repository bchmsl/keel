 ...
 * and the renderer.
 */
public enum class FormattingMarker(
...
public data class TextSelection(val start: Int, val end: Int)

/** Text with a selection in it, as a field would report and then be set back to. */
public data class FormattedField(val text: String, val selection: TextSelection)
